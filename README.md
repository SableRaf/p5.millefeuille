...
`dist/` is generated by CI and not checked in. After a fresh clone, run `npm run build` or `npm run examples` before working with the library locally. See [PUBLISHING.md](PUBLISHING.md) for release instructions.
